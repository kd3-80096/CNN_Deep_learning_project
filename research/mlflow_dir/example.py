...
if __name__ == "__main__":
    ...
    with mlflow.start_run():
        ...
        remote_server_uri = "https://dagshub.com/deveshpatil619/CNN_Deep_learning_project.mlflow"
        mlflow.set_tracking_uri(remote_server_uri) ##Set the tracking server URI
